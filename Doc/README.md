...
# Nutzbarkeit:
  -	Auf der Applikation sollen drei Autos zur Verfügung stehen und jeweils die wichtigsten Informationen zu den Fahrzeugen. -> Als Nutzer möchte ich ein Auto wählen, um das Auto zu mieten.
